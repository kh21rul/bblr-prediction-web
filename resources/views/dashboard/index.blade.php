                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('dashmin/img/avatar/avatar-1.png') }}" alt="avatar">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('dashmin/img/avatar/avatar-2.png') }}" alt="avatar">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('dashmin/img/avatar/avatar-3.png') }}" alt="avatar">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('dashmin/img/avatar/avatar-4.png') }}" alt="avatar">
                                    <div class="media-body">
                            ...
                            <div class="row pb-2">
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('dashmin/img/avatar/avatar-5.png') }}"
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('dashmin/img/avatar/avatar-4.png') }}"
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('dashmin/img/avatar/avatar-1.png') }}"
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('dashmin/img/avatar/avatar-2.png') }}"
                                ...
                                <div class="summary-item">
                                    ...
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="{{ asset('dashmin/img/products/product-1-50.png') }}"
                                                    alt="product">
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="{{ asset('dashmin/img/products/product-2-50.png') }}"
                                                    alt="product">
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <a href="#">
                                                <img class="mr-3 rounded" width="50"
                                                    src="{{ asset('dashmin/img/products/product-3-50.png') }}"
                                                    alt="product">
                                            </a>
                                            <div class="media-body">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="media">
                                    ...
                                    <img class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('dashmin/img/avatar/avatar-5.png') }}" alt="avatar">
                                    <div class="media-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600"><img
                                                        src="{{ asset('dashmin/img/avatar/avatar-1.png') }}"
